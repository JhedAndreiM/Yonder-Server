                    ...
                    <div class="graph-container">
                        ...
                        <div class="graph-container-left">
                            ...
                            <div class="graph-container-minicards">
                                <div class="minicards-top">
                                    <div class="cards-totalSales firstCard">
                                        <div class="firstCard-top">Top Sales</div>
                                        <div class="firstCard-middle"><h1>PHP 120, 178</h1></div>
                                        <div class="firstCard-bottom">View Report <span>-></span></div>
                                    </div>
                                ...
                                <div class="minicards-bottom">
                                    <div class="cards-totalSales secondCard">
                                        ...
                                        <div class="firstCard-middle"><h1>Wireless Mouseeeeeeeeeeeeeeeeee</h1></div>
                                        <div class="firstCard-bottom">View Report <span>-></span></div>
                                    </div>
                            ...
                            <div class="graph-container-recents">
                                <pre>{{ print_r($monthlySalesData, true) }}</pre>
                            </div>
                        </div>
